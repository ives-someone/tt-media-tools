...
视频重命名工具集 TT 入口"
===============================
【1】 视频文件名扫描添加时间         # 跳转到二级菜单1
【2】 含时长视频文件名清理           # 跳转到二级菜单2
【3】 大写文件名扩展改成小写         # ext_lower.ps1   
【4】 汉字数字重命名为01~10         # cn_num2seq.ps1
【5】 NFO同步：刷新同名nfo内部名称   # nfo同步模块
...
扫描添加时间 - 二级菜单
================================
【1】 保留原名，时长追加到新文件名末尾     # time_add_end.ps1
【2】 保留原名，时长放新文件名开头         # time_add_begin.ps1
【3】 不保留原名，直接用时长作为新文件名   # time_add_only.ps1

【任意键返回上级菜单】
================================
"请按数字键选择："

二级菜单2，推荐直接用自动识别，若自动识别有误再用23的逻辑判断

================================
清理时长文件名 - 二级菜单
================================
【1】 自动识别文件名中的时间             # time_clr_auto.ps1
【2】 视频文件名里的时长在文件名末尾      # time_clr_end.ps1
【3】 视频文件名里的时长在文件名开头      # time_clr_begin.ps1
